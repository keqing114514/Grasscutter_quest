...
public class PlayerProgressManager extends BasePlayerDataManager {
    ...
    **********/
    public void onPlayerLogin() {
        // Try unlocking open states on player login. 
    ...
    **********/
    private boolean areConditionsMet(OpenStateData openState) { 
        ...
        for (OpenStateCond condition : openState.getCond()) {
            ...
            if (condition.getCondType() == OpenStateCondType.OPEN_STATE_OFFERING_LEVEL) {
                // ToDo: Implement.
                return false;
                ...
                if (this.player.getQuestManager().getQuestById(condition.getParam()) == null 
                    || this.player.getQuestManager().getQuestById(condition.getParam()).getState() == QuestState.QUEST_STATE_NONE
                    || this.player.getQuestManager().getQuestById(condition.getParam()).getState() == QuestState.QUEST_STATE_UNSTARTED
                    || this.player.getQuestManager().getQuestById(condition.getParam()).getState() == QuestState.QUEST_STATE_UNFINISHED){
                    return false;
                }
                ...
                if (this.player.getQuestManager().getMainQuestById(condition.getParam()) == null 
                    || this.player.getQuestManager().getMainQuestById(condition.getParam()).getState() == ParentQuestState.PARENT_QUEST_STATE_NONE){
                    return false;
                }
            }
        }
